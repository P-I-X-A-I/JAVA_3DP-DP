...
public class matrixClass {
	...
	{
		float radian = degree * 0174532925f;
		float cosVal = (float)Math.cos(radian);
		float sinVal = (float)Math.sin(radian);
	...
	{
		tempM[0] = sx;		tempM[4] = 0.0f;	tempM[8] = 0.0f;
		tempM[1] = 0.0f;	tempM[5] = sy;		tempM[9] = 0.0f;
		tempM[2] = 0.0f;	tempM[6] = 0.0f;	tempM[10] = sz;
		tempM[3] = 0.0f;	tempM[7] = 0.0f;	tempM[11] = 0.0f;
